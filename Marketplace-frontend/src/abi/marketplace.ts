export const MARKETPLACE_ABI = [
  ...
  {
    "type": "function",
    "name": "getAllListingTokens",
    "inputs": [],
    "outputs": [
      {
        "name": "",
        "type": "tuple[]",
        "internalType": "struct MarketplaceStorage.ListedToken[]",
        "components": [
          {
            "name": "nftAddress",
            "type": "address",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct MarketplaceStorage.Auction",
        "components": [
          {
            "name": "seller",
            "type": "address",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple[]",
        "internalType": "struct MarketQuery.ListingView[]",
        "components": [
          {
            "name": "price",
            "type": "uint256",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct MarketQuery.MarketplaceInfo",
        "components": [
          {
            "name": "totalListings",
            "type": "uint256",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct MarketplaceStorage.Offer",
        "components": [
          {
            "name": "buyer",
            "type": "address",
    ...
    "outputs": [
      {
        "name": "",
        "type": "tuple",
        "internalType": "struct MarketplaceStorage.Rental",
        "components": [
          {
            "name": "landlord",
            "type": "address",
  ...
  },
  {
    ...
    "inputs": [
      ...
      },
      {
        ...
        "type": "uint8",
        "indexed": false,
        "internalType": "enum MarketEvents.ListingRemovalReason"
      }
    ],
    "anonymous": false
  },
